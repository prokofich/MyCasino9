...
class GameTwoPlayersFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //загрузка аватарок
        loadSmiles(requireArguments().getInt(NUMBER_AVATAR_PLAYER_1),requireArguments().getInt(NUMBER_AVATAR_PLAYER_2))
    ...
    private fun loadImageDicePlayer1(points:Int){
        when(countDicePlayer1){
            1 -> {
                loadBackgroundImage(listUrlImageDice[points-1],idgame_two_iv_img_dice1_player1)
            }
            2 -> {
                loadBackgroundImage(listUrlImageDice[points-1],idgame_two_iv_img_dice2_player1)
            }
            3 -> {
                loadBackgroundImage(listUrlImageDice[points-1],idgame_two_iv_img_dice3_player1)
            }
        }
    }
    ...
    private fun loadImageDicePlayer2(points:Int){
        when(countDicePlayer2){
            1 -> {
                loadBackgroundImage(listUrlImageDice[points-1],idgame_two_iv_img_dice1_player2)
            }
            2 -> {
                loadBackgroundImage(listUrlImageDice[points-1],idgame_two_iv_img_dice2_player2)
            }
            3 -> {
                loadBackgroundImage(listUrlImageDice[points-1],idgame_two_iv_img_dice3_player2)
            }
        }
    }
